...
from explainers.refine_simple import ReFine
...
print(f"Using GNN model from {path}")
...
torch.save(explainer, osp.join(model_dir, f'{args.dataset}{mod_path}_{args.random_seed if args.random_seed else ""}.pt'))
